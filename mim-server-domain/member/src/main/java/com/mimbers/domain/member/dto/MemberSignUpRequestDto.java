...
public class MemberSignUpRequestDto {
    ...
    public static MemberSignUpRequestDto from(Member member) {
        ...
        return MemberSignUpRequestDto.builder()
                ...
                .score(memberResponse.score())
                .mbti(memberResponse.mbti())
                .role(memberResponse.role())
                .build();
    }

    public static MemberSignUpRequestDto from(MemberResponse member) {
        return MemberSignUpRequestDto.builder()
