...
@AllArgsConstructor
public class MemberSeePersonalInfoRequestDto {
    ...
    public static MemberSeePersonalInfoRequestDto from(MemberResponse member) {
        return MemberSeePersonalInfoRequestDto.builder()
