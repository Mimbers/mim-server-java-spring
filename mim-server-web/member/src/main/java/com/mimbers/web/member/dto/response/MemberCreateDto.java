...
import com.mimbers.domain.member.dto.*;
...
public class MemberInfoResponse {
    ...
    public static MemberInfoResponse from(MemberSignUpRequestDto member) {
    ...
    public static MemberInfoResponse from(MemberSeeInfoRequestDto member) {
        return MemberInfoResponse.builder()
                .username(member.username())
                .nickname(member.nickname())
                .birthDay(member.birthDay())
    ...
    public static MemberInfoResponse from(MemberEditRequestDto member) {
        return MemberInfoResponse.builder()
                .username(member.username())
                .nickname(member.nickname())
                .birthDay(member.birthDay())
